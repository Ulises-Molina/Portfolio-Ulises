...
export const Project3:React.FC<ComponentProps> = ({lenguage}) => {
    return (
        ...
        className="h-full hover:cursor-pointer  md:min-w-[700px] relative group transition-all duration-500 overflow-hidden">
            ...
            <motion.img 
            src="/public/proyectos/mercadosur-rec.gif" alt="gif proyecto MercadoSur" className="w-full lg:h-full object-contain rounded-md shadow-slate-500"></motion.img>
            <span
        ...
        className="flex flex-col gap-6 lg:gap-12 max-w-[800px] justify-center items-center lg:justify-normal lg:items-start m-2">
            ...
            <div className="flex gap-10">
                ...
                <Logo src="/public/logos/css.svg" alt="logo Tailwind" delay={1} y={3} x={6} link="https://developer.mozilla.org/es/docs/Web/CSS"></Logo>
                <Logo src="/public/logos/materialui.svg" alt="logo Material" delay={1.4} y={8} x={5} link="https://mui.com/"></Logo>
                <Logo src="/public/logos/reactrouter.svg" alt="logo Router" delay={1.4} y={8} x={5} link="https://reactrouter.com/"></Logo>
            </div>
